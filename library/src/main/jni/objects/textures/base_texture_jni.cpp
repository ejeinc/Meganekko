...
JNIEXPORT jlong JNICALL
Java_com_eje_1c_meganekko_NativeBaseTexture_bareConstructor(JNIEnv * env, jobject obj, jintArray jtexture_parameters);
JNIEXPORT jboolean JNICALL
Java_com_eje_1c_meganekko_NativeBaseTexture_update(JNIEnv * env, jobject obj,
