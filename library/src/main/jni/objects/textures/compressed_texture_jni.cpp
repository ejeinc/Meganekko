...
Java_com_eje_1c_meganekko_asynchronous_NativeCompressedTexture_normalConstructor(JNIEnv * env,
...
JNIEXPORT jlong JNICALL
Java_com_eje_1c_meganekko_asynchronous_1textures_NativeCompressedTexture_mipmappedConstructor(JNIEnv * env,
...
Java_com_eje_1c_meganekko_asynchronous_NativeCompressedTexture_normalConstructor(JNIEnv * env,
    ...
    CompressedTexture* texture =
            new CompressedTexture(target, internalFormat, width, height, imageSize, data, texture_parameters);
