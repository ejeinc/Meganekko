...
public class JoyButton {
    ...
    /**
     * @param buttonState Returned value from {@code FrameInput#getButtonPressed()},
     *                    {@code FrameInput#getButtonReleased()} or
     *                    {@code FrameInput#getButtonState()}.
     * @param code        JoyButton.BUTTON_* constant value.
     * @return true if {@code buttonState} contains {@code code} in bit flags.
     */
