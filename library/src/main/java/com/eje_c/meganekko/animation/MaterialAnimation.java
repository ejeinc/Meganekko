...
public abstract class MaterialAnimation extends Animation {
     ...
     *
     * @param target   May be a {@link Material} or a {@link SceneObject} -
     *                 does runtime checks.
     * @param duration The animation duration, in seconds.
     * @throws IllegalArgumentException If {@code target} is neither a {@link Material} nor a
     *                                  {@link SceneObject}
     ...
     * for an example.
     *
     * @param target   {@link SceneObject} containing a {@link Material}
     * @param duration The animation duration, in seconds.
     */
