 ...
 * {@linkplain #loadTexture(AndroidResource) GL textures.} {@code GVRContext}
...
public class VrContext {
     ...
     * 
     * @param settings
     *            Additional import {@link ImportSettings settings}
     * @return A {@link SceneObject} that contains the meshes with textures
     * 
     * @throws IOException
     *             File does not exist or cannot be read
     ...
     *            A reference of the {@link SceneObject}, to which all other
    ...
    /**
     * Get the current {@link Scene}, which contains the scene graph (a
