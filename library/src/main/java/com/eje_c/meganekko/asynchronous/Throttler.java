...
import com.eje_c.meganekko.utility.Threads.Cancelable;
...
abstract class Throttler {
    ...
    private static class PendingRequests {
        ...
        private final Map<AndroidResource, PendingRequest> pendingRequests = new ConcurrentHashMap<AndroidResource, PendingRequest>();
        ...
        private class PendingRequest implements
                CancelableCallback<HybridObject>, PriorityCancelable {
            ...
            public void loaded(HybridObject gvrResource,
                ...
                // AsyncLoadImage.run)
                if (gvrResource != null) {
                    List<CancelableCallback<? extends HybridObject>> listeners = new ArrayList<CancelableCallback<? extends HybridObject>>();
                    do {
                        /*
            ...
            @Override
            public boolean stillWanted(AndroidResource request) {
                for (CancelableCallback<? extends HybridObject> callback : callbacks) {
            ...
            public boolean stillWanted() {
                synchronized (callbacks) {
                    List<CancelableCallback<? extends HybridObject>> canceled = new ArrayList<CancelableCallback<? extends HybridObject>>(
                            callbacks.size());
                    for (CancelableCallback<? extends HybridObject> callback : callbacks) {
