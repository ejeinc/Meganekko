 ...
 * <p/>
 * When you call one of the {@linkplain Picker#pickScene(Scene)
...
public class EyePointeeHolder extends Component {
     ...
     * @param descendantsCleanupHandlerList Cleanup handler(s).
     *                                      <p/>
     *                                      <p/>
     ...
     */
    protected EyePointeeHolder(VrContext vrContext, long nativePointer, List<NativeCleanupHandler> descendantsCleanupHandlerList) {
     ...
     *
     * @param eyePointee The {@link EyePointee} to add
     */
     ...
     *
     * @param eyePointee A Future {@link EyePointee}, probably from
     *                   {@link RenderData#getMeshEyePointee()}
     */
    public void addPointee(final Future<EyePointee> eyePointee) {
        // The Future<EyePointee> may well actually be a FutureWrapper, not a
        // 'real' Future
     ...
     *
     * @param eyePointee The {@link EyePointee} to remove
     */
