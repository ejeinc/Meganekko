 ...
 * com.eje_c.meganekko.MeganekkoActivity}, not directly from {@code Activity}.
 * 
 ...
 * com.eje_c.meganekko.MeganekkoActivity#setScript(GVRScript, String)} 
 * (or to {@link 
 * com.eje_c.meganekko.MeganekkoActivity#setScript(GVRScript, String, GVRSurfaceViewRenderer)}.
 * 
 * A {@linkplain com.eje_c.meganekko.Scene scene graph} contains any 
 * number of {@linkplain com.eje_c.meganekko.SceneObject scene 
 * objects.} Scene objects have an {@linkplain com.eje_c.meganekko.Transform 
 ...
 * 
 * <p>
 * To be visible, a scene object must have {@linkplain com.eje_c.meganekko.RenderData
 * render data,} including a {@linkplain com.eje_c.meganekko.Mesh GL 
 * mesh} which defines the surface geometry and a {@linkplain com.eje_c.meganekko.Material
