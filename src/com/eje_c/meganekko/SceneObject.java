...
public class SceneObject extends HybridObject {
	 ...
	 */
	public SceneObject(VrContext gvrContext) {
		this(gvrContext, NativeSceneObject.ctor());
	}
	
	protected SceneObject(VrContext gvrContext, long nativePointer) {
	 ...
	 */
	public SceneObject(VrContext gvrContext, Mesh mesh) {
		this(gvrContext);
	 ...
	 */
	public SceneObject(VrContext gvrContext, float width, float height) {
	 ...
	 */
	public SceneObject(VrContext gvrContext, Future<Mesh> futureMesh,
	 ...
	 */
	public SceneObject(VrContext gvrContext, AndroidResource mesh,
