...
#if 1
	char const * localeName = "en";
#else
	char const * localeName = "zh-rCN";
#endif
	localePtr = new ovrLocaleInternal( name, localeName );

	char languageFolder[128] = "values";
	char const * languageCode = localePtr->GetLanguageCode();
	if ( OVR_stricmp( localePtr->GetLanguageCode(), "en" ) != 0 )
	{
