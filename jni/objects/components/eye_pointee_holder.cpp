...
EyePointData EyePointeeHolder::isPointed(const OVR::Matrix4f& view_matrix, float ox,
        float oy, float oz, float dx, float dy, float dz) {
    OVR::Matrix4f mv_matrix = view_matrix * owner_object()->transform()->getModelMatrix();
...
EyePointData EyePointeeHolder::isPointed(const OVR::Matrix4f& view_matrix) {
